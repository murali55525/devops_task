...
pipeline {
    ...
    environment {
        IMAGE_NAME = "murali555/sample"          // Replace with your Docker Hub username and image name
        TAG = "latest"
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                ...
                git branch :'main' ,url:'https://github.com/murali55525/docker-final1.git'  // Replace with your repo URL
            }
        }
...
![Screenshot from 2025-03-21 13-42-26](https://github.com/user-attachments/assets/04dd568d-4d39-4088-b30f-82bea2e84bf7)
